...
module.exports = function(app) {
    ...
    app.post("/api/friends", function(req, res) {
        ...
        // default friends match is the first friend but result will be whoever has the minimum difference in scores
        ...
        //what ever the difference is, add to the total difference
